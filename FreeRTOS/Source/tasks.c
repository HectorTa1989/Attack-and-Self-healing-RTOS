...
/*-----------------------------------------------------------*/
	...
	BaseType_t xAlreadyYielded, xShouldDelay = pdFALSE;
		...
		{
			portYIELD_WITHIN_API(); //calls portYIELD, calls SWI 0, calls vPortYieldProcessor, calls vTaskSwitchContext
		}
		else
		{
			mtCOVERAGE_TEST_MARKER();
...
/*-----------------------------------------------------------*/
	...
	TCB_t *pxTCB;
		...
		if( pxTCB == pxCurrentTCB )
		{
			...
			{
#ifdef DEBUG
                cprintf("vTaskSuspend: portYIELD\n");
#endif
			...
			else
			{
				...
				{
#ifdef DEBUG
                    cprintf("vTaskSuspend: TaskSwitchContext\n");
#endif
		...
		if( uxSchedulerSuspended == ( UBaseType_t ) pdFALSE )
		{
			if( uxCurrentNumberOfTasks > ( UBaseType_t ) 0U )
			{
				...
				if( xYieldPending != pdFALSE )
				{
					...
					#endif
					taskYIELD_IF_USING_PREEMPTION(); //portYIELD => SAVE, TaskSwitchContext, RESTORE
				}
				else
				{
					mtCOVERAGE_TEST_MARKER();
...
#ifdef DEBUG
        cprintf("vTaskSwitchContext: scheduler suspended\n");
#endif
	}
	else
	{
